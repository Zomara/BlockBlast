...
def render():
    ...
    pygame.draw.rect(window, (0, 100, 0), (SCREEN_WIDTH-10, 0, 10, len(memory)*SCREEN_HEIGHT/3))
...
def place_piece(piece_map, piece_x, piece_y):
    placement = []
    for row_num, row in enumerate(piece_map):
